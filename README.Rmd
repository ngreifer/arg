...
You can install the development version of arg from [GitHub](https://github.com/) with:
...
*arg* has a similar function to other existing packages. These packages may be better for your purposes, and *arg* is not meant to compete with them. 
